...
export default function IntegranteDashboard() {
  ...
  return (
    <div>
      <Header title="Minha Jornada" userName={currentMember?.name ?? team.leader.name} subtitle={`Integrante da equipe ${team.ideaName}`} />
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card rounded-xl border border-card-border p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/integrante/tarefas" className="text-sm text-primary hover:text-primary-dark">
                  Ver todas
                </Link>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm text-foreground">
                      {team.leader.name} <span className="text-xs text-primary">(líder)</span>
                    </p>
                ...
                {team.members.map((m) => (
                  <div key={m.id} className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-sm text-foreground">
                        {m.name} {m.id === currentMember?.id && <span className="text-xs text-primary">(você)</span>}
                      </p>
